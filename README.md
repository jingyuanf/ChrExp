...
## Step 2: Run our model (Gene expression -> Chromatin Signal)

Run "ChromExp/run_models.sh", run "train_across_model_w_gene_exp_sampled.R" first and then run "test_across_model_w_gene_exp_sampled.R" next.
